...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_update = "UPDATE $table SET name = :name, email =:email, degree =:degree WHERE $id_field = :id";
...
<div class="container mt-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">Chỉnh sửa thông tin Giáo viên</h4>
        </div>
        <div class="card-body">
            <form method="post" action="editteacher.php?id=<?php echo htmlspecialchars($id); ?>&role=<?php echo htmlspecialchars($role); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="degree" name="degree" class="form-control"
                           value="<?php echo htmlspecialchars($record['degree']); ?>" required>
                </div>
