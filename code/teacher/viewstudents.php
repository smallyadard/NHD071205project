...
<div class="container-fluid mt-4">
    <div class="row">
        <div class="col-12 text-center">
            <h2 class="mb-4">Danh sách sinh viên - <?php echo htmlspecialchars($coursename); ?></h2>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <?php else: ?>
                <div class="alert alert-warning" role="alert">Không có sinh viên nào trong môn học này.</div>
            <?php endif; ?>
        </div>
    </div>
</div>
